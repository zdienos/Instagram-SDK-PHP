...
try {
    ...
    //Find the User you want to get Stories of
    $user = $instagram->getUserByUsername("instagram");

    //Get User ReelMedia (Stories)
    $reelMedia = $instagram->getReelMediaUserFeed($user);

    //User Object, (who posted these stories)
    $user = $reelMedia->getUser();

    //FeedItems (Stories by this User)
    $items = $reelMedia->getItems();
